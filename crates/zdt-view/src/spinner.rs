...
//! smooth wheel in the width of a character, and every nerd font has them. A timer swaps the
//! glyph, and the renderer animates nothing. A spinner is eight strings.
//!
