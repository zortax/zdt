...
//!
//! Nothing here names a user-interface crate. A chord goes in and a list of actions comes out.
//! Every motion, operator and text object is a function from a borrowed rope and a cursor to a
//! byte range. That is what makes the whole grammar testable by asserting on text.
