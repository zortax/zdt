...
//!
//! A new file's name, a rename, `:` later, an LSP rename after that. Each is the same thing: a
//! title, a starting value, and something to do with what was typed. So they share one floating
//! input, and none of them grows a dialog of its own.
//!
...
pub struct Pending {
    ...
    pub start: String,
    /// What to do with the answer. A cancelled prompt calls nothing.
