...
pub fn TreeResize() -> impl IntoView {
    ...
    // Where the pointer went down and how wide the tree was then. Taken as a delta rather than
    // from the tree's own box, so nothing here has to be measured or converted.
