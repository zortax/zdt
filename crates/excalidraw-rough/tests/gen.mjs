...
cases.path_rounded_solid = dump(g.path('M 32 0 L 188 0 Q 220 0, 220 32 L 220 96 Q 220 128, 188 128 L 32 128 Q 0 128, 0 96 L 0 32 Q 0 0, 32 0', { ...base, preserveVertices: true, fill: '#a5d8ff', fillStyle: 'solid', fillWeight: 1, hachureGap: 8 }));
cases.curve_solid = dump(g.curve([[0, 0], [92, -26], [176, 16]], { ...base, fill: '#a5d8ff', fillStyle: 'solid', fillWeight: 1, hachureGap: 8 }));
